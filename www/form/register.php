...
<div class="container">
  <form name="myform" id="myform" class="myform" action="register.php" autocomplete="off" method="post" onsubmit="return !!(validateUsername() & validatePassword() & validatePassword2() & validateDate() & validatePhone() & validateEmail());">
  <!--display back-end validation errors here-->
