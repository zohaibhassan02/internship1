...
// Calling function
    $query=$userdata->usernameavailability($uname);
    $num=mysqli_num_rows($query);
    if($num > 0){
        $uname_err = "Username already associated with another account";
    } 
    else{
...
//Function Calling
        $sql=$userdata->register($fname,$uname,$uemail,$password,$phone);
        if($sql){

            $mailer=$userdata->phpmail($uemail);
...
<div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
          ...
          <span style='color:red'><?= $uname_err; ?></span>
      </div>
    </div>
